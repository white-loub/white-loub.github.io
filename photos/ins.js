    ...
    var render = function render(res) {
      ...
      for (var j = 0, len2 = res.list.length; j < len2; j++) {
        ...
        for (var i = 0, len = data.link.length; i < len; i++) {
		  ...
		  var minSrc = 'https://white-loub.coding.net/p/blog/d/blog/git/raw/master/photos/min_photos/' + data.link[i];
          var src = 'https://white-loub.coding.net/p/blog/d/blog/git/raw/master/photos/photos/' + data.link[i];
